...
void gemm_pe(
    ...
    for(int r = 0; r < NUM_QUERY; r++){
        ...
        for(int r_k = 0; r_k < ((current_pos + 128) >> 7); r_k++){
            ...
            // pass previous scores
            for(int i = 0; i < (pe_id << 3); i++) {
                #pragma HLS pipeline II=1
...
void gemm_pe_1(
    ...
    gemm_pe<1>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_2(
    ...
    gemm_pe<2>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_3(
    ...
    gemm_pe<3>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_4(
    ...
    gemm_pe<4>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_5(
    ...
    gemm_pe<5>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_6(
    ...
    gemm_pe<6>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void gemm_pe_7(
    ...
    gemm_pe<7>(L, NUM_QUERY, qk_vec_fifo, score_in_fifo, score_out_fifo);
}
...
void topk_parallel_cmp(
  ...
  for(int q = 0; q < NUM_QUERY; q++){
    ...
    const int remain_len = (((L + (q/8) + 128) >> 7) << 6) - (TOP_K >> 4);
...
void indexer_top(
    ...
    tapa::task()
        ...
        .invoke<tapa::join>(
            gemm_pe_head, L, NUM_QUERY, qk_vec_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_1, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_2, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_3, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_4, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_5, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_6, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            gemm_pe_7, L, NUM_QUERY, qk_vec_fifo, score_out_fifo, score_out_fifo
        )
        .invoke<tapa::join>(
            topk_parallel_cmp, L, NUM_QUERY, score_out_fifo, topk_id_fifo
        )
        .invoke<tapa::join>(
